import { UPLOADS_URL } from 'codebase/http';
import IMessage from 'codebase/models/IMessage';
import { Context } from 'index';
import { observer } from 'mobx-react-lite';
import { useContext, useEffect, useState } from 'react';
import { useParams } from 'react-router-dom';
import { BodySmsBot, BodySmsButton, DateContainer, DeleteTrash, EditPencil, Img, ImgContainer } from "styles/pages/Chat/ChatMobilChat";
interface Props{
    msg: IMessage
}

export const MessageMobil = ({ msg } : Props) =>{
...
export default observer(MessageMobil)